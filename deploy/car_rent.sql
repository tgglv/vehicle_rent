...
INSERT INTO `customer` VALUES (1,'Гоголев Тимур',176),(2,'Гоголева Дарья',176),(3,'Shurick Agapitov',205);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Точки проката';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rental_point` VALUES (1,176,'Московский центр проката',55.794945,37.611427),(2,176,'Пермский центр проката',56.180870,57.980989),(3,205,'New York Rental Point',40.747865,-73.990619),(4,205,'LA Beverly Hills Rental Point',34.069277,-118.406260);
...
INSERT INTO `rental_point_vehicle` VALUES (2,1,0),(2,2,1),(2,3,1),(2,4,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='ТС';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vehicle` VALUES (1,'car','camry',1,'A 123 BC'),(2,'bike','wave',2,'D 345 EF'),(3,'scooter','dfx',2,'G 877 HT'),(4,'bike','yam-1',4,'G 543 GF');
...
CREATE TABLE `vehicle_rent` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='Информация о прокате ТС';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vehicle_rent` VALUES (9,3,1,2,'2017-09-23 15:05:46',2,'2017-09-23 16:05:46'),(10,2,1,2,'2016-12-23 15:06:45',2,'2017-09-23 17:06:45'),(11,1,2,2,'2012-09-22 15:08:11',2,'2017-09-22 18:08:11'),(12,3,1,2,'2017-09-22 15:00:00',2,'2017-09-22 16:00:00'),(13,3,1,2,'2017-09-21 15:00:00',2,'2017-09-21 17:00:00'),(14,4,2,2,'2017-09-20 16:15:51',2,'2017-09-20 20:15:51'),(15,1,1,2,'2017-09-24 10:20:21',2,'2017-09-24 15:52:30'),(16,3,2,2,'2017-09-24 10:20:30',2,'2017-09-24 10:44:40'),(17,4,2,2,'2017-09-24 10:44:51',2,'2017-09-24 16:43:46'),(18,1,1,2,'2017-09-24 15:52:45',2,'2017-09-24 15:53:22'),(19,1,1,2,'2017-09-24 15:54:15',2,'2017-09-24 16:53:07'),(20,4,2,2,'2017-09-24 16:43:56',2,'2017-09-24 16:51:28'),(21,4,2,2,'2017-09-24 16:51:59',2,'2017-09-24 16:53:16'),(22,4,2,2,'2017-09-24 16:56:39',2,'2017-09-24 16:59:20'),(23,1,1,2,'2017-09-24 17:00:52',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Марка ТС';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vendor` VALUES (2,'Honda'),(3,'Mazda'),(5,'Suzuki'),(1,'Toyota'),(4,'Yamaha'),(6,'АвтоВаз');
...
-- Dump completed on 2017-09-26 21:29:09
